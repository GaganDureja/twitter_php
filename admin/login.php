...
if(isset($sub))
{	
	$sel=mysqli_query($link,"select * from users where email='$em' ");
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="em" placeholder="Email" class="form-control" autocomplete="off" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="m-account--actions">
                                        ...
                                        <button type="submit" class="btn btn-rounded btn-info" name="sub">Login</button>
                                    </div>
