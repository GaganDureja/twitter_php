<?php
   ...
   if(isset($sub))
    ...
    if(mysqli_query($link,"insert into users (Name, email, password) values ('$Uname','$Uemail', '$Upass')"))
    {
                                ...
                                <form method="post">
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="email" name="Uemail" placeholder="Email" class="form-control" autocomplete="off" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" name="Upass" placeholder="Password" class="form-control" autocomplete="off" required>
                                        </div>
                                    </div>
                                    ...
                                    <div class="m-account--actions">
                                        <button type="submit" name='sub' class="btn btn-block btn-rounded btn-info">Register</button>
                                    </div>
